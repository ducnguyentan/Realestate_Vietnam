    ...
    <>
      ...
      <main className="min-h-screen bg-cream py-xl px-md">
        <div className="mx-auto max-w-wide">
          <h1 className="font-heading text-4xl font-bold text-gray-dark mb-md">Mua bán nhà phố</h1>
          <p className="text-lg text-gray-medium mb-lg">
            Trang mua bán nhà phố đang được phát triển. Vui lòng quay lại sau.
          </p>
          <div className="rounded-xl bg-white p-xl shadow-md text-center">
            ...
            <p className="text-gray-medium">
              Chúng tôi đang hoàn thiện tính năng tìm kiếm và mua bán nhà phố để mang đến trải
