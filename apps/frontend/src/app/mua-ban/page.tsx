      ...
      <main className="min-h-screen bg-cream py-xl px-md">
        <div className="mx-auto max-w-wide">
          ...
          <p className="text-lg text-gray-medium mb-lg">
            Trang mua bán bất động sản đang được phát triển. Vui lòng quay lại sau.
          </p>
          <div className="rounded-xl bg-white p-xl shadow-md text-center">
            ...
            <p className="text-gray-medium">
              Chúng tôi đang hoàn thiện tính năng mua bán bất động sản để mang đến trải nghiệm tốt
              nhất cho bạn.
            </p>
          </div>
        </div>
